...
class CameraDemo(mglw.WindowConfig):
  gl_version = (3, 3)
  title = "COM6025M — Camera"
  window_size = (800, 600)
  ...
  def __init__(self, **kwargs):
    ...
    self.prog = self.ctx.program(
      vertex_shader=load_shader('week04/shaders/cube.vert'),
      fragment_shader=load_shader('week04/shaders/cube.frag'),
    )
...
if __name__ == '__main__':
  mglw.run_window_config(CameraDemo)